...
#
  ...
  set mom_sys_alt_unit_post_name                "wv__IN.pui"
...
#=============================================================
  ...
  global mom_motion_event
   ...
   set rapid_traverse_blk {G_motion G_mode X Y Z M_spindle S}
   set rapid_traverse_xy_blk {G_motion G_mode X Y M_spindle S}
   set rapid_traverse_yz_blk {G_motion G_mode Y Z M_spindle S}
   set rapid_traverse_xz_blk {G_motion G_mode X Z M_spindle S}
...
MOM_output_literal "(DIA=[ format "%.2f" $mom_tool_diameter] R=[ format "%.2f" $mom_tool_corner1_radius] STOCK=[format "%.2f" $mom_stock_part]MM)"
}
